...
- Niels Wouda (author of the vendored PyVRP C++ core) \[contributor,
  copyright holder\]

- Thibaut Vidal (HGS-CVRP, parts of the vendored C++ core) \[copyright
  holder\]

- ORTEC (HGS-DIMACS, parts of the vendored C++ core) \[copyright
  holder\]
